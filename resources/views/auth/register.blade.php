        ...
        <div class="m-login__signin">
          ...
          <form class="m-login__form m-form" action="{{ route('register') }}" method="post" autocomplete="off">
            ...
            <div class="form-group m-form__group">
              ...
              <span class="m-form__help text-justify m--margin-top-10">
                By signing up, you agree to have read and agree to our <a href="#" class="m-link m-link--info">Terms of Service</a> and <a href="#" class="m-link m-link--info">Privacy Policy</a>, including <a href="#" class="m-link m-link--info">Cookie Use</a>. In case you have any questions, please do not hesitate to contact us or our support team at <a href="mailto:app.chexnet@gmail.com" class="m-link m-link--info">app.chexnet@gmail.com</a>. We'll be happy to help.
              </span>
            </div>

            <div class="m-login__form-action m--margin-top-10">
              <button id="signup-btn" class="btn btn-focus btn-block m-btn m-btn--air m-btn--custom m-login__btn m-login__btn--primary" type="submit">
                Sign up
              </button>
            </div>
          </form>
