    ...
    <div class="col-12">
      <div class="m-alert m-alert--outline alert alert-info" role="alert">
        <div class="m-alert__text">
          ...
          Your payment details inserted herein do not touch our servers. They are securely processed and safely guarded in secrecy by our payment gateway, <a href="https://braintreepayments.com" class="m-link m-link--info" target="_blank">Braintree</a>. In case you have any questions, please do not hesitate to contact us or our support team at <a href="mailto:app.chexnet@gmail.com" class="m-link m-link--info">app.chexnet@gmail.com</a>. We'll be happy to help.
        </div>
      </div>
    </div>
  </div>
    ...
    >
      ...
      <div class="m-portlet__body">
        ...
        <div class="form-group m-form__group row {{ $errors->has('date') ? 'has-danger' : '' }}">
          ...
          <div class="col-lg-9 col-md-12 col-sm-12">
            <div class="m-input-icon m-input-icon--left">
              <input id="date" class="form-control m-input {{ $errors->has('date') ? 'form-control-danger' : '' }}" 
                type="text" 
                name="date" 
      ...
      <div class="m-portlet__foot">
        <div class="m-form__actions">
          <div class="row">
            ...
            <div class="col-sm-7">
              <button type="submit" class="btn btn-sm btn-focus m-btn m-btn--air m-btn--custom m-btn--wide m-btn--icon save-btn">
                Save
              </button>
              &nbsp;&nbsp;
