...
>
  ...
  <div class="m-portlet__body">
    ...
    <div class="form-group m-form__group row {{ $errors->has('new_password') ? 'has-danger' : '' }}">
      ...
      <div class="col-lg-10 col-md-12 col-sm-12">
        <div class="m-input-icon m-input-icon--left">
          <input class="form-control m-input {{ $errors->has('new_password') ? 'form-control-danger' : '' }}" 
            type="password" 
            name="new_password" 
    ...
    <div class="form-group m-form__group row {{ $errors->has('new_password_confirmation') ? 'has-danger' : '' }}">
      ...
      <div class="col-lg-10 col-md-12 col-sm-12">
        <div class="m-input-icon m-input-icon--left">
          <input class="form-control m-input {{ $errors->has('new_password_confirmation') ? 'form-control-danger' : '' }}" 
