  ...
  <div class="m-portlet__body m--margin-bottom-45">
    <div class="form-group m-form__group row m--margin-top-25 {{ $errors->has('name') ? 'has-danger' : '' }}">
      ...
      <div class="col-lg-10 col-md-12 col-sm-12">
        ...
        <span class="m-form__help">
          Please enter and/or type letters only for your full name.
        </span>
      </div>
    </div>
    ...
    <div class="form-group m-form__group row">
      ...
      <div class="col-lg-10 col-md-12 col-sm-12">
        ...
        <span class="m-form__help">
          Your email address in the form <code>username@domain.com</code>.
        </span>
      </div>
    </div>
    ...
    <div class="form-group m-form__group row {{ $errors->has('google_id') ? 'has-danger' : '' }}">
      ...
      <div class="col-lg-10 col-md-12 col-sm-12">
        <div class="input-group m-input-group">
          ...
          <input class="form-control m-input {{ $errors->has('google_id') ? 'form-control-danger' : '' }}" type="text" name="google_id" placeholder="Google+" value="{{ old('google_id', $user->google_id) }}">
        </div>
  ...
  <div class="m-portlet__foot">
    <div class="m-form__actions">
      <div class="row">
        ...
        <div class="col-sm-7">
          <button type="submit" class="btn btn-sm btn-focus m-btn m-btn--custom m-btn--wide m-btn--air m-btn--icon save-btn">
            Save
          </button>
          &nbsp;&nbsp;
